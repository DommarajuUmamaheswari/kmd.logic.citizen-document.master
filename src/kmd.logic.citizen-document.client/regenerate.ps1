autorest --input-file=citizen_document.swagger.json --output-folder=. --namespace=kmd.logic.citizen_document.client --csharp --override-client-name=InternalClient --add-credentials
